    ...
    if st.session_state.q3 == 'zielony':
        ...
        if st.session_state.q4 == 'Ty':
            ...
            if b:
                ...
                image1 = Image.open('pages/ss1.png')
                image2 = Image.open('pages/ss2.png')
                image3 = Image.open('pages/ss3.png')
                image4 = Image.open('pages/ss4.png')
                image5 = Image.open('pages/ss5.png')
