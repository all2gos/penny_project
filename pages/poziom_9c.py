...
try:
    ...
    if st.session_state.q11 == 'Wysłałaś mi podcast z Draganem i Czajką i pogadaliśmy trochę o AI':
        ...
        st.write('Brawo dotarłaś do końca naszej wspaniałej zabawy. Nie chciałem tego jakoś przesadnie przedłużać, bo to też nie o to chodzi. Mam nadzieję, że fajnie się bawiłaś wspominając nasze początki i wspólne miłe chwile.')
        ...
        st.write('Nie wiem czy mogę Ci czegoś szczególnego życzyć, jak wiesz nie specjalnie sympatyzuję z tym formalizmem. Ale gdybym miał zrobić to szybko a konkretnie, to życzyłbym Ci radości z życia i poczucia spełnienia: nieważne gdzie, z kim i w jakiej formie miałyby one nadejść')
